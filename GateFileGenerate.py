...
class MacWriter(object):
    def __init__(self, case: str, sim: str) -> None:
        self.case = case
        self.sim = sim
        self.fpath = os.path.join("data", case, sim, "main.mac")
    ...
    def initialization(self):
        ...
        self.content.append(f'# GATE Macro Script Generated by Python')
    ...
    def actor_statistic(self, saveEveryNSeconds=20):
        self.content.append(f'#==============================================================================')
    ...
    def actor_DoseActor_image(self, region=None):
        ...
        self.content.append(f'/gate/actor/dose3d/saveEveryNSeconds     600')
        self.content.append(f'\n')
    ...
    def source_pet_F18(self, img):
        ...
        self.content.append(f'/gate/source/pet/setForcedHalfLife          6586.2 s')
        self.content.append(f'/gate/source/pet/gps/ene/type               Mono')
        self.content.append(f'/gate/source/pet/gps/ene/mono               0.2498 MeV')
...
def create_mac_PETLike_CTLike(case, phantom, source, atlas=None, N=5E8, sim="s1"):

    w = MacWriter(case, sim)
    w.initialization()
    w.material()
    w.geometry_ct(img=phantom)
    w.actor_statistic(saveEveryNSeconds=20)
    w.actor_DoseActor_image(region=atlas)
    w.physics_petct()
    w.initialize()
...
def create_mac_PETLike_AtlasLike(case, phantom, source, atlas=None, N=5E8, sim="s1"):
